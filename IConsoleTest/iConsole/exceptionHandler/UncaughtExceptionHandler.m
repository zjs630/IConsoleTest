...
- (void)validateAndSaveCriticalApplicationData:(NSException *)exception {
    ...
    [exceptionInfo writeToFile:[NSString stringWithFormat:@"%@/Library/Caches/error%@.log",NSHomeDirectory(),time]  atomically:YES encoding:NSUTF8StringEncoding error:nil];
}
